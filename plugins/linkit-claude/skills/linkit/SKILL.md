---
description: Publish complete single-file HTML pages as public Linkit URLs from Claude.
---

Use Linkit when the user asks to publish, share, or create a public URL for a complete standalone HTML page.
...
- Linkit URLs are public links with a fixed 3-day expiry.
- Do not publish secrets, credentials, private keys, or sensitive personal content.
- Return the Linkit URL and expiry after publishing.
